/*
    ...
    Использую System.arraycopy для получения среза массива с поз. 1 до конца
*/
package Tsuker;
            ...
            case 3:                         // Если длины обоих массивов не равны 0
                while (i < lensum) {        // Цикл по элементам суммирующего массива
                    ...
                    if (mem1 <= mem2) {     // Условие засылки меньшего элемента
                        ...
                        System.arraycopy(a1, 1, a1, 0, len1 - 1);   // Срез с 1 поз. до конца
                        ...
                        System.arraycopy(a2, 1, a2, 0, len2 - 1);   // Срез с 1 поз. до конца
